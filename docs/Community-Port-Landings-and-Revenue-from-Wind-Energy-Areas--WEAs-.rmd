...
title:
    | 
    | SMART Indicator Report: Community Port Landings and Revenue from Wind Energy Areas (WEAs)
    | 
...
indicator_name <- "Community Port Landings and Revenue from Wind Energy Areas (WEAs)"
...
keywords <- data.frame(keystring = c("water quality", "temperature", "sst", "salinity", "habitat", "warm", "cold", "gulf stream", "slopewater", "heat", "sound", "thermal", "transition",
                                     ...
                                     "community", "social",
                                     "offshore wind"),
                       category = c(rep("Habitat-Physical", 13),
